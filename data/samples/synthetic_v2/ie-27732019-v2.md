*Number* 7 *of* 2026 <!-- Revised Acts edit log (synthetic for demo). Edit 1 (MOVED): section 11 of the Act (which amends section 10 of the Principal Act) is renumbered to 11A. The Law Reform Commission's Revised Acts edition restores the engrossed-bill numbering; the gazette-published text mis-printed it as "section 11". The clause body is byte-identical; only the structural label changes, so the parser emits a MOVED event with the path moving from PART 2 / section 11 to PART 2 / section 11A. Edit 2 (MODIFIED): the upper bound of the Minister's order-making power under the new section 11(5A)(a) of the Principal Act (variation of the notice period referred to in section 4B(1)(a)(ii)) is widened from "not more than 12 weeks" to "not more than 16 weeks", responding to early operational experience with the deeming process. Single token swap; lower bound and statutory voice unchanged. -->
...
**11A\.** Section 10(2A) of the Principal Act is amended by the substitution of “but for the limit set by section 6(4\)(a) (as may be varied by regulations under section 11(5\)), or by section 6(4\)(aa), as the case may be,” for “but for the limit set by section 6(4\)(a) (as may be varied by regulations under section 11(5\)),”.
...
“(5A) (a) The Minister may, from time to time, by order amend section 4B so as to substitute for the number of weeks specified in subsection (1\)(a)(ii) of that section a different number of weeks, being not less than 4 weeks but not more than 16 weeks.
